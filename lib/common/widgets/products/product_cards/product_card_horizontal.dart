              ...
              child: Column(
                children: [
                  const Column(
                    ...
                    children: [
                      TProductTitleText(title: 'Wardah Colorfit Velvet Matte Lip Mousse', smallSize: true,),
                      SizedBox(height: TSizes.spaceBtwItems / 2,),
                      TBrandTitleTextWithVerifiedIcon(title: 'Wardah')
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      /// -- Pricing
                      const Flexible(child: TProductPriceText(price: '63.200 - 79.000')),
