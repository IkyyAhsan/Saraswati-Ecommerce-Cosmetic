...
import 'package:saraswati_application_project/features/personalization/screens/profile/widgets/re_authenticate_user_login_form.dart';
...
class UserController extends GetxController{
  ...
  void deleteAccountWarningPopup(){
    Get.defaultDialog(
      ...
      middleText: 
      'Are you sure want to delete your account permanently? This action is not reversible and all your data will be removed permanently.',
  ...
  void deleteUserAccount()async{
    try{
      TFullScreenLoader.OpenLoadingDialog('Processing', TImages.checkedIllustration);
  ...
  uploadUserProfilePicture() async{
    try{
      final image = await ImagePicker().pickImage(source: ImageSource.gallery, imageQuality: 78, maxHeight: 512, maxWidth: 512);
      if(image != null){
