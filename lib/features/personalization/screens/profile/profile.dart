...
import 'package:saraswati_application_project/features/personalization/screens/profile/widgets/change_name.dart';
import 'package:saraswati_application_project/features/personalization/screens/profile/widgets/profile_menu.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              TProfilMenu(onPressed: () => Get.to(() => const ChangeName()), title: 'Name', value: controller.user.value.fullName,),
              TProfilMenu(onPressed: () {}, title: 'Username', value: controller.user.value.username,),
              ...
              const SizedBox(height: TSizes.spaceBtwItems,),
              TProfilMenu(title: 'User ID', value: controller.user.value.id,icon: Iconsax.copy, onPressed: (){}),
              TProfilMenu(title: 'E-mail', value: controller.user.value.email, onPressed: (){}),
              TProfilMenu(title: 'Phone Number', value: controller.user.value.phoneNumber, onPressed: (){}),
              TProfilMenu(title: 'Gender', value: 'Male', onPressed: (){}),
              TProfilMenu(title: 'Date of Birth', value: '20 Feb, 2003', onPressed: (){}),
              const Divider(),
              const SizedBox(height: TSizes.spaceBtwItems,),
