                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        Text('31 Des 2023', style: Theme.of(context).textTheme.headlineSmall,),
                    ],
                  ),
                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Order', style: Theme.of(context).textTheme.labelMedium!),
                              Text('#256rw', style: Theme.of(context).textTheme.titleMedium,),
                          ],
                        ),
                      ),
                    ],
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Shipping Date', style: Theme.of(context).textTheme.labelMedium!),
                              Text('06 Jan 2023', style: Theme.of(context).textTheme.titleMedium,),
                          ],
                        ),
                      ),
                    ],
