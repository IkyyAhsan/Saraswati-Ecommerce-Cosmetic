...
class TValidator {
  ...
  static String? validateUsername(String? username){
    ...
    //Check if the username doesn't start and end with an underscore or hyphen
    if (isValid){
  ...
  static String? validatePhoneNumber(String? value) {
    ...
    // Regular expression for phone number validation (assuming a 12-digit US phone number format)
